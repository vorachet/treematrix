...
function render(treeModelInstance, colModel) {
    ...
    var html = treeModelInstance.isChild ? '<tr data-tt-id="' + treeModelInstance.id + '" data-json=\'' + JSON.stringify(instance) + '\' data-tt-parent-id="' + treeModelInstance.parentId + '">' : '<tr data-tt-id="' + treeModelInstance.id + '" data-json=\'' + JSON.stringify(instance) + '\' >';
...
var treematrix = {
    ...
    build: function (tableElementID, caption, colModel, treeModel, clickEventFunc) {
        var targetEL = __WEBPACK_IMPORTED_MODULE_0_jquery__("#" + tableElementID);
        const uid = makeUID(10);
        targetEL.append('<table id="' + uid + '"></table>');

        var targetTableEL = __WEBPACK_IMPORTED_MODULE_0_jquery__("#" + uid);
