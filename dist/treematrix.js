...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vendor_jquery_treetable_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vendor_jquery_treetable_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__vendor_jquery_treetable_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vendor_jquery_treetable_css__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vendor_jquery_treetable_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__vendor_jquery_treetable_css__);
...
function render(treeModelInstance, colModel) {
    ...
    var html = treeModelInstance.isChild ? '<tr id="' + treeModelInstance.id + '" data-tt-id="' + treeModelInstance.id + '" data-json=\'' + JSON.stringify(instance) + '\' data-tt-parent-id="' + treeModelInstance.parentId + '">' : '<tr id="' + treeModelInstance.id + '" data-tt-id="' + treeModelInstance.id + '" data-json=\'' + JSON.stringify(instance) + '\' >';
...
var treematrix = {
    ...
    build: function (loader, options) {
        ...
        const selector = loader.selector,
              caption = loader.caption,
              colModel = loader.cols,
              treeModel = loader.tree,
              clickEventFunc = loader.callback,
              targetDIV = __WEBPACK_IMPORTED_MODULE_0_jquery__("#" + selector),
              uid = makeUID(10);

        targetDIV.append('<table id="' + uid + '"></table>');

        const targetTable = __WEBPACK_IMPORTED_MODULE_0_jquery__("#" + uid);
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery__("#" + uid).treetable({ expandable: true, initialState: "expanded" });
        __WEBPACK_IMPORTED_MODULE_0_jquery__("#" + uid + " tbody").on("mousedown", "tr", function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__(".selected").not(this).removeClass("selected");
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).toggleClass("selected");
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./jquery.treetable.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./jquery.treetable.css");
