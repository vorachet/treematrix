...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vendor_jquery_treetable_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vendor_jquery_treetable_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__vendor_jquery_treetable_js__);
...
function render(treeModelInstance, colModel) {
    var html = treeModelInstance.isChild ? '<tr data-tt-id="' + treeModelInstance.id + '" data-json=\'' + JSON.stringify(treeModelInstance) + '\' data-tt-parent-id="' + treeModelInstance.parentId + '">' : '<tr data-tt-id="' + treeModelInstance.id + '" data-json=\'' + JSON.stringify(treeModelInstance) + '\' >';
...
var treematrix = {
    ...
    build: function (tableElementID, caption, colModel, treeModel, clickEventFunc) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#" + uid).treetable({ expandable: true, initialState: "expanded" });
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#" + uid + " tbody").on("mousedown", "tr", function () {
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".selected").not(this).removeClass("selected");
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).toggleClass("selected");
