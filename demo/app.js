...
const reqTraceDemoSelector = "RequirementsTraceability"
const reqTraceDemoCaption = "Requirements Traceability";

treematrix.build(
  reqTraceDemoSelector,
  reqTraceDemoCaption,
  reqTraceDemoColModel,
  reqTraceDemoTreeModel,
  (selected) => {
    console.log(selected);
});


const raciDemoSelector = "RACI"
const raciDemoCaption = "RACI (Responsible, Accountable, Consulted, and Informed)";
